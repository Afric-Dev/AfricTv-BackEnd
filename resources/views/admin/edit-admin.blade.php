        ...
        <div class="dash-content">
            ...
            <div class="activity">
                ...
                <div class="">
                    ...
                    <form action="{{ route('admin-add-edit') }}" method="POST" style="max-width: 600px; margin: 0 auto; padding: 30px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;">
                        @csrf

                        <h2 style="text-align: center; margin-bottom: 20px; font-size: 24px; font-weight: bold; color: #333;">Edit Admin Information</h2>
                        <!-- Name Field -->
                        <div style="margin-bottom: 20px;">
                            <label for="name" style="display: block; font-weight: bold; margin-bottom: 8px; font-size: 16px; color: #555;">Name</label>
                            <input type="text" id="name" name="name" value="{{ $admin->name }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-size: 14px; color: #333; background-color: #fff;" required>
                        </div>

                        <!-- Email Field -->
                        <div style="margin-bottom: 20px;">
                            <label for="email" style="display: block; font-weight: bold; margin-bottom: 8px; font-size: 16px; color: #555;">Email</label>
                            <input type="email" id="email" name="email" value="{{ $admin->email }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-size: 14px; color: #333; background-color: #fff;" required>
                        </div>

                        <!-- Mobile Field -->
                        <div style="margin-bottom: 20px;">
                            <label for="mobile" style="display: block; font-weight: bold; margin-bottom: 8px; font-size: 16px; color: #555;">Mobile</label>
                            <input type="number" id="mobile" name="mobile" value="{{ $admin->mobile }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-size: 14px; color: #333; background-color: #fff;" required>
                        </div>
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <select id="role" name="role" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-size: 14px; color: #333; background-color: #fff;" required>
                                ...
                                <option value="ACCOUNT" {{ $admin->role == 'ACCOUNT' ? 'selected' : '' }}>Account</option>
