                        ...
                        <tbody>
                          @foreach($posts as $post)
                            <tr>
                              ...
                              <td> <a href="#" onclick="confirmStatusChange('{{ $post->id }}', '{{ $post->is_status }}')" class="btn btn-danger" id="status-btn-{{ $post->id }}">
  ...
  function confirmStatusChange(postId, currentStatus) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = '/admin/videos/' + postId + '/update-status-id';
      }
    });
  }
</script>
